...
<div class="banner-white-wave">
  ...
  <div class="container">
 <nav class="navbar navbar-expand-lg navbar-light bg-light nav-menu padd-35">
  <a class="navbar-brand" href="#"><!-- <p class="temporary">Photofery</p> --> <img src="{{ asset('/public/images/logo.png')}}" alt=""></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="#photographer">Photographer</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#faq">Faq</a>
      </li>
      <li class="nav-item">
        <a class="btn nav-link nav-download-a" href="#">Download</a>
      </li>
    </ul>
  </div>
</nav>
...
<div id="features" class="book-on padd-80">
  <div class="container">
    <div class="book-slogan text-center">
      <h3 class="head-color font-pirate">Reach Photographer in 30 minutes</h3>
...
<div class="how-work-main padd-80">
  <div class="container">
    <div class="how-work-body">
      <h3 class="text-center text-capitalize head-color pb-5 font-pirate">How Does It Work?</h3>
          <div class="row">
            <div class="col-md-3">
    ...
    <div class="subscrive-main-body">
          <div class="row">
            <div class="col-lg-6">
              ...
              <h4 class="font-pirate">Do you want photographer right now?</h4>
           ...
           <div class="col-lg-6">
            <div class="video-block text-center">
              <iframe width="600" height="400" src="https://www.youtube.com/embed/P--uT2sWcEE"></iframe>
             </div>
            </div>
          </div>
    </div>
...
<div class="store-owner text-center padd-60">
  <div class="container">
    <div class="book-slogan text-center">
      <h3 class="head-color font-pirate">More for Photographers</h3>
      ...
      <div class="row">
        ...
        <div class="col-md-3">
          <div class="store-owner">
            ...
            <p>By providing a direct and sincere pipeline of work to the photographers, so they can easily upgrade their their skill.</p>
          </div>
        </div><!-- col -->
        <div class="col-md-3">
          <div class="store-owner">
...
<div class="screenshot-ui padd-80">
  <div class="container">
    <div class="screen-header text-center">
      <h3 class="head-color font-pirate">Screenshot UI</h3>
    </div>
...
<div id="faq" class="ask-question padd-80">
  <div class="container">
    <div class="book-slogan text-center">
      <h3 class="head-color font-pirate">Most Asked Quetions</h3>
              ...
              <div class="panel panel-default">
                ...
                <div id="collapseOne" class="panel-collapse collapse in show" role="tabpanel" aria-labelledby="headingOne" aria-expanded="true" style="">
                  <div class="panel-body">
                    <p>Photofery connects you with professional photographers. Photofery is first on-demand freelancer photographer marketplace in bangladesh, where customers can easily book photographers and also help professionals get more work.</p>
                  </div>
                </div>
              </div>
              <div class="panel panel-default">
